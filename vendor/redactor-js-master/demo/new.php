...
<head>
	...
	$(document).ready(
		function()
		{
			$('#redactor_content').redactor({
				...
				//imageGetJson: '../demo/json/data.json'
				  imageGetJson: '../demo/json/data.php'
			});
		}
	); 
	</script>
      ...
      <?php /*?>    <?php   
			$jsonData = file_get_contents("../demo/json/data.json");
			...
			foreach ($phpArray as $key => $value) { 
				...
				//	echo "$k | $v <br />"; 
		 	?><script>
 [{ "thumb": "json/images/<?php echo $v; ?>", "image": "json/images/<?php echo $v; ?>", "title": "Image 1", "folder": "Folder 1" }]  	
										</script>  
			<?php	}
			}?><?php */?>
