...
$app->post('/sales/crm/crm/get-crm', function () use ($app) {
    ...
    $result = $objCrm->get_crm_by_id($array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
$app->post('/sales/crm/crm/get-alt-contact', function () use ($app) {
    ...
    $result = $objCrm->get_alt_contact_by_id($array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
$app->post('/sales/crm/crm/delete-price-offer', function () use ($app) {
    ...
    $result = $objCrm->delete_price_offer($input_array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
$app->post('/sales/crm/crm/add-promotion', function () use ($app) {
    ...
    $result = $objCrm->add_crm_promotion($input);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
$app->post('/sales/crm/crm/convertion-price-list', function () use ($app) {
    ...
    $result = $objCrm->convertion_price_list($array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
$app->post('/sales/crm/crm/add-crm-rebate', function () use ($app) {
    global $objCrm, $input;
    $input_array = array();
    ...
    $result = $objCrm->add_crm_rebate($input_array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});

$app->post('/sales/crm/crm/update-crm-rebate', function () use ($app) {
    global $objCrm, $input;
    $input_array = array();
    ...
    $result = $objCrm->update_crm_rebate($input_array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});

$app->post('/sales/crm/crm/delete-crm-rebate', function () use ($app) {
    global $objCrm, $input;
    $input_array = array();
    ...
    $result = $objCrm->delete_crm_rebate($input_array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
$app->post('/sales/crm/crm/update-social-media', function () use ($app) {
    global $objCrm, $input;
    $input_array = array();
    foreach ($input as $key => $val) {
        $input_array[$key] = $val;
    ...
    $result = $objCrm->update_crm_social_media($input_array);
    $app->response->setStatus(200);
    $app->response()->headers->set('Content-Type', 'application/json');
    echo json_encode($result);
});
...
/* ================     Get Customer Price History start   ================== */
...
/* ================     Get Customer Price History End   ================== */
?>