...
else if (strpos($path, "setup/otherCompanies") !== false) {
    require_once(SERVER_PATH . "/classes/OtherCompanies.php");
    $objSetupOtherCompanies = new OtherCompanies($user_info);
    require_once(SERVER_PATH . '/modules/setup/otherCompanies.php');
}
...
if (strpos($path, "setup/general") !== false) require_once(SERVER_PATH . '/modules/setup/general.php');

else if (strpos($path, "setup/supplier") !== false) require_once(SERVER_PATH . '/modules/setup/supplier.php');

else if (strpos($path, "setup/ledger-group") !== false) require_once(SERVER_PATH . '/modules/setup/ledger-group.php');

else if (strpos($path, "setup/crm") !== false) require_once(SERVER_PATH . '/modules/setup/crm.php');

else if (strpos($path, "setup/hr") !== false) require_once(SERVER_PATH . '/modules/setup/hr.php');

else if (strpos($path, "setup/region") !== false) require_once(SERVER_PATH . '/modules/setup/region.php');

else if (strpos($path, "setup/srm_region") !== false) require_once(SERVER_PATH . '/modules/setup/srm_region.php');

else if (strpos($path, "setup/territories_hr") !== false) require_once(SERVER_PATH . '/modules/setup/hr_territories.php');

else if (strpos($path, "setup/ownership") !== false) require_once(SERVER_PATH . '/modules/setup/ownership_type.php');

else if (strpos($path, "setup/credit-rating") !== false) require_once(SERVER_PATH . '/modules/setup/credit_rating.php');

else if (strpos($path, "setup/competitors") !== false) require_once(SERVER_PATH . '/modules/setup/competitors.php');
