...
class QueryMaster extends Xtreme {
        ...
        if(LOG_LEVEL >= $srLogTrace['LOG_LEVEL'])
        {
            ...
            $Sql = "INSERT INTO srtrace 
                                    SET
                                        ...
                                        Parameter2 = '" . addslashes($srLogTrace['Parameter2'])  . "',
                                        Parameter3 = '" . addslashes($srLogTrace['Parameter3'])  . "',
                                        Parameter4 = '" . addslashes($srLogTrace['Parameter4'])  . "',
                                        Parameter5 = '" . addslashes($srLogTrace['Parameter5'])  . "',
                                        Parameter6 = '" . addslashes($srLogTrace['Parameter6'])  . "',
                                        input_text = '" . addslashes($srLogTrace['input_text'])  . "',
                                        log_level = ".LOG_LEVEL.",
                                        log_type   = '".SR_TRACE_PHP."',
                                        error_message = '".addslashes($srLogTrace['ErrorMessage'])."',
                                        error_code = '".$error_code."',
    ...
    function CSI ($query, $permissionModule = null, $permission = null){
        ...
        if ($allowed){
            ...
            switch($permission){
                case(1): $permName = "Add";break;
                case(2): $permName = "Edit";break;
                case(3): $permName = "View";break;
                case(4): $permName = "Delete";break;
                case(5): $permName = "Approve";break;
                case(6): $permName = "Convert";break;
                case(7): $permName = "Dispatch";break;
                case(8): $permName = "Post";break;
                case(9): $permName = "Receive";break;
                case("1,2"): $permName = "Add/Edit";break;
            }
