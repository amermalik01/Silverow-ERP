...
=======
                if ($selected_count == 0) $result['quantity'] = (float) 1;
                else $result['quantity'] = (float) 0;
>>>>>>> e31237e9eb73244117d4370f0a4bd96ad1c30564
                $selected_count++;
                $response['response'][] = $result;
            }
...
=======
        ...
        if ($this->Conn->Affected_Rows() > 0) {
            ...
            $response['id'] = $arr_attr['itemID'];
            $response['error'] = 'Record Updated Successfully';
            $response['msg'] = 'Record Updated Successfully'; //$message;
        }
...
=======
                FROM product_volume_discount   pv
                where   pv.status=1 and pv.company_id=" . $this->arrUser['company_id'] . "	
                $where_clause";
...
=======
                            || (($to >= $value['start_date']) && ($to <= $value['end_date'])))) /* if( (  ( $from > $this->objGeneral->convert_date(gmdate("d-m-Y", $value['start_date'])) ) 
>>>>>>> e31237e9eb73244117d4370f0a4bd96ad1c30564
