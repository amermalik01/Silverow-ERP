...
/*	var $smtp_host      = "smtp.googlemail.com";        // SMTP Server.
	var $smtp_user      = "shifa.stmu@gmail.com";       // SMTP Username
	var $smtp_pass      = "pakistan09";     // SMTP Password*/
	var	$smtp_host		= "mail3.gridhost.co.uk";//"mail.shifacollege.edu";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "mudassir@navsonsoftware.com";//"noreply@stmu.edu.pk";		// SMTP Username
	var	$smtp_pass		= "gpcmm2015";//"ahsandanish";	        	// SMTP Password
	var	$smtp_port      = "110";//"587";        // SMTP Port 
	...
	public function message($body)
	{
		...
		/* strip slashes only if magic quotes is ON
		   ...
		   NOTE: In PHP 5.4 mysqli_real_escape_string() will always return 0 and
