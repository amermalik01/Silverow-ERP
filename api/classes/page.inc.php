		...
		function get_first_page_nav($user_link="",$link_para="",$returnHtml=false)
		{
			...
			if(!$this->is_first_page()&& $this->show_first_last)
			{
				if(empty($this->jsHandler))
			    	...
			    	$html = ' <a href="javascript:void(0);" onclick="'.$this->jsHandler.'(\''.$this->page_name.'\',\'0'.$this->qry_str.'\')" '.$link_para.'>'.$user_link.'</a> ';
			}
		...
		function get_last_page_nav($user_link="",$link_para="",$returnHtml=false)
		{
			...
			if(!$this->is_last_page()&& $this->show_first_last)
			{
				if(empty($this->jsHandler))
			    	...
			    	$html = ' <a href="javascript:void(0);" onclick="'.$this->jsHandler.'(\''.$this->page_name.'\',\''.($this->total_page-1).$this->qry_str.'\')" '.$link_para.'>'.$user_link.'</a> ';
			}
			elseif($this->show_first_last && $this->show_disabled_links)
			    $html =  $user_link;
		...
		function get_next_page_nav($user_link="",$link_para="",$returnHtml=false)
		{
			...
			if(!$this->is_last_page()&& $this->show_prev_next)
			{
				if(empty($this->jsHandler))
			    	...
			    	$html = ' <a href="javascript:void(0);" onclick="'.$this->jsHandler.'(\''.$this->page_name.'\',\''.($this->page+1).$this->qry_str.'\')" '.$link_para.'>'.$user_link.'</a> ';
			}
		...
		function get_scroll_prev_page_nav($user_link="",$link_para="",$returnHtml=false)
		{
			...
			if($this->page>$this->scroll_page &&$this->show_scroll_prev_next)
			{
				if(empty($this->jsHandler))
			    	...
			    	$html = ' <a href="javascript:void(0);" onclick="'.$this->jsHandler.'(\''.$this->page_name.'\',\''.($this->page-$this->scroll_page).$this->qry_str.'\')" '.$link_para.'>'.$user_link.'</a> ';
			}
			...
			for(;$i<$j+$scroll_page && $i<$this->total_records;$i++)
			{
				...
				else
				{
					if(empty($this->jsHandler))
				    	...
				    	$html .= ' <a href="javascript:void(0);" onclick="'.$this->jsHandler.'(\''.$this->page_name.'\',\''.$i.$this->qry_str.'\')" '.$link_para.'>'.($i+1).'</a> ';
				}
			}
