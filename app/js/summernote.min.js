...
var DropdownUI = /** @class */ (function () {
    ...
    DropdownUI.prototype.clear = function () {
        ...
        $parent.find('.note-btn.active').removeClass('active-lite');
        $parent.removeClass('open');
    };
    DropdownUI.prototype.show = function () {
        this.$button.removeClass('active-lite');
        this.$button.addClass('active-lite');
    ...
    DropdownUI.prototype.hide = function () {
        this.$button.removeClass('actives');
...
var editable = renderer.create('<div class="note-editable" style="font-family:calibri !important;font-size:12px;" contentEditable="true" role="textbox" aria-multiline="true"/>');
...
var button = renderer.create('<button type="button" class="note-btn" role="button" tabindex="-1">', function ($node, options) {
    ...
    if (options && options.data && options.data.toggle === 'rename-dropdown') {
...
var ui = {
    ...
    toggleBtnActive: function ($btn, isActive) {
        $btn.toggleClass('active-lite', isActive);
    },
    ...
    */
    ...
    Table.prototype.createTable = function (colCount, rowCount, options) {
        ...
        for (var idxCol = 0; idxCol < colCount; idxCol++) {
            tds.push('<td style="border: 1px solid #989898;padding: 3px 5px;background-color: white !important;">' + dom.blank + '</td>');
        }
        tdHTML = tds.join('');
        var trs = [];
        var trHTML;
        ...
        trHTML = trs.join('');
        var $table = $$1('<table cellspacing="0" style="width: auto !important;">' + trHTML + '</table>');
...
var HintPopover = /** @class */ (function () {
    ...
    HintPopover.prototype.initialize = function () {
        ...
        this.$content.on('click', '.note-hint-item', function () {
            _this.$content.find('.active').removeClass('active-lite');
            $$1(_this).addClass('active-lite');
            _this.replace();
        });
    };
    ...
    HintPopover.prototype.selectItem = function ($item) {
        this.$content.find('.active').removeClass('active-lite');
        $item.addClass('active-lite');
        ...
        if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
            ...
            if (this.hints.length && keyword_1) {
                ...
                if (bnd) {
                    ...
                    this.$content.find('.note-hint-item:first').addClass('active-lite');
