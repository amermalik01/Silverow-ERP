...
function OverriderAddController($scope, $stateParams, $http, $state,toaster){
...
function OverriderViewController($scope, $stateParams, $http, $state, $resource,ngDialog,toaster){
	 $scope.formTitle = 'Overrider';
	 $scope.btnCancelUrl = 'app.overrider';
	 $scope.hideDel = false;
	$scope.breadcrumbs = 
...
function OverriderEditController($scope, $stateParams, $http, $state, $resource,toaster){
