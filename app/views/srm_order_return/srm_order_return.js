...
function SrmOrderReturnEditController($scope, $filter, $resource, $timeout, $http, ngDialog, toaster, $stateParams, $state, $rootScope, ModalService, serviceVariables, $q, generatePdf, moduleTracker) {
    ...
    $scope.saveDebitNoteInvoice = function(rec) {
        ...
        invoiceRec.shipping_agent_code = rec.shipping_agent_code;

        invoiceRec.shippingAgentRefNo = rec.shippingAgentRefNo;
        invoiceRec.freight_charges = rec.freight_charges;
        invoiceRec.shipment_date = rec.shipment_date;
        invoiceRec.deliveryDate = rec.deliveryDate;
        ...
        invoiceRec.book_in_contact = rec.book_in_contact;
        invoiceRec.book_in_tel = rec.book_in_tel;
        invoiceRec.shipToSupplierLocContact = rec.shipToSupplierLocContact;
        invoiceRec.shipToSupplierLocPostCode = rec.shipToSupplierLocPostCode;
        invoiceRec.shipToSupplierLocCounty = rec.shipToSupplierLocCounty;

        invoiceRec.shipToSupplierLocCity = rec.shipToSupplierLocCity;
        invoiceRec.shipToSupplierLocAaddress2 = rec.shipToSupplierLocAaddress2;
        invoiceRec.shipToSupplierLocAddress = rec.shipToSupplierLocAddress;
        invoiceRec.shipToSupplierLocName = rec.shipToSupplierLocName;


        invoiceRec.billToSupplierName = rec.billToSupplierName;
        invoiceRec.billToSupplierAddress = rec.billToSupplierAddress;
        invoiceRec.billToSupplierAddress2 = rec.billToSupplierAddress2;
        invoiceRec.billToSupplierCity = rec.billToSupplierCity;
        invoiceRec.billToSupplierCounty = rec.billToSupplierCounty;
        invoiceRec.billToSupplierPostCode = rec.billToSupplierPostCode;
        invoiceRec.billToSupplierContactID = rec.billToSupplierContactID;
        invoiceRec.billToSupplierContact = rec.billToSupplierContact;
        invoiceRec.billToSupplierTelephone = rec.billToSupplierTelephone;
        invoiceRec.billToSupplierEmail = rec.billToSupplierEmail;

        invoiceRec.supplierName = rec.supplierName;
        invoiceRec.supplierAddress = rec.supplierAddress;
        invoiceRec.supplierAddress2 = rec.supplierAddress2;
        invoiceRec.supplierCity = rec.supplierCity;
        invoiceRec.supplierCounty = rec.supplierCounty;
        invoiceRec.supplierPostCode = rec.supplierPostCode;
        invoiceRec.supplierContactID = rec.supplierContactID;
        invoiceRec.supplierContactName = rec.supplierContactName;
        invoiceRec.supplierContactTelephone = rec.supplierContactTelephone;
        invoiceRec.supplierContactEmail = rec.supplierContactEmail;
        invoiceRec.supplierCreditNoteNo = rec.supplierCreditNoteNo;

        invoiceRec.Purchaser = rec.Purchaser;
        invoiceRec.purchaserID = rec.purchaserID;
        ...
        var updateInvoiceUrl = $scope.$root.pr + "srm/srmorderreturn/update-posted-debit-note";
    ...
    $scope.RemovePurchaseInvFromOrder = function() {
        $scope.rec.purchaseInvoice = '';
        $scope.rec.purchaseInvoiceID = 0;
        $scope.rec.purchaseInvoiceType = '';
        angular.element('#_invoicesModal').modal('hide');
    }
