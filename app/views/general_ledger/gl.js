...
function GlControllerTreeTable($scope, $stateParams, $http, $state, $resource, toaster, Calendar, $window, ngDialog, $rootScope, $timeout) {
        ...
        if (record_id > 0) {
            ...
            .then(function(res) {
                ...
                if (res.data.ack == true) {
                    ...
                    /* angular.forEach($scope.posting_allow_list, function (obj) {

                        if (obj.id == res.data.response.allowPosting)

                            $scope.formData.allow_posting = obj;
    ...
    $scope.getSubCategoriesByParentID = function(parentCatID) {
        ...
        .then(function(res) {
            ...
            if (res.data.ack == true) {
                ...
                // toaster.pop('error', 'Error', "No Sub Category Record exist for that category");
    ...
    $scope.getGlHeading = function() {
        ...
        // var sub_catid = this.formData.category_ids.id;

        // var parent_catid = this.formData.gl_category_ids.id;
        ...
        // var parent_catid = $scope.formData.gl_category_ids.id;
    ...
    $scope.addGeneral = function(formData) {
        ...
        // console.log($scope.category_sub_list.length);
...
function GlControllerEdit($scope, $stateParams, $http, $state, $resource, toaster, Calendar, $window, ngDialog, $timeout) {
    ...
    $scope.show_add_pop = function(parent_id, cid, one, scd, level) {
        ...
        $timeout(function() {
            ...
            .then(function(res) {
                ...
                //  document.getElementById('number').value=res.data.response.code;
    ...
    $scope.addGeneral = function(formData) {
        ...
        //$scope.formData.posting_type = $scope.formData.posting_types !== undefined ? $scope.formData.posting_types.id:0;	
        ...
        .then(function(res) {
            ...
            if (res.data.ack == true) {
                ...
                // $timeout(function(){ $state.go("app.general_ledger" ); },2000);
...
function GlControllerTREE($scope, $stateParams, $http, $state, $resource, toaster, Calendar, $window, ngDialog, $timeout, $rootScope, jsreportService) {
    ...
    /* $timeout(function () {
        ...
        $http
            ...
            .post(postUrl_cat, { 'token': $scope.$root.token, 'display_id': 10 })
    ...
    $scope.show_add_pop = function(parent_id, cid, one, scd, level, record_id, trd) {
        ...
        $timeout(function() {
            ...
            //	console.log(record_id);console.log(trd);
            ...
            if (record_id === '') {
                ...
                //console.log($scope.perreadonly);

                //console.log($scope.check_gl_readonly);
        ...
        .then(function(res) {
            ...
            if (res.data.ack == true) {
                ...
                /*if(res.data.info == 'Add'){
                 ...
                 $timeout(function(){  $state.go("app.edit_gl", {id: res.data.gl_id}); },2000);
...
function GlControllerReceipt($scope, $stateParams, $http, $state, $resource, toaster, $window, ngDialog, dataService, $rootScope, $timeout, $filter) {
    ...
    /* $scope.currency_id_defult = 0;

    // $rootScope.get_currency_list();

    if ($rootScope.arr_currency != undefined) {

        angular.forEach($rootScope.arr_currency, function (index, elem) {

            if (elem.id == $scope.$root.defaultCurrency)

                $scope.currency_id_defult = elem;
            ...
            .then(function (res) {
                ...
                if (res.data.ack == true) {
                    ...
                    if (res.data.response.conversion_rate == null) {
                        ...
                        // if (item.debit_amount > 0 && type == 'lev2')

                        //     item.converted_price = converted_price;// Display as a minus
                    ...
                    toaster.pop('error', 'Info', 'Please set the conversion rate');
    ...
    $scope.showEditReceipt = function(id, flg) {
                ...
                if ($scope.array_receipt_gl_form.module_type == 3) {
                    ...
                    /* angular.forEach($scope.template_arr, function (obj3) {
                        ...
                        if (obj3.id == res.data.response.template_id)
                            ...
                            $scope.array_receipt_gl_form.template_id = obj3;
        ...
        // $scope.$root.load_date_picker('Journal Recipt');
    ...
    $scope.addReceipt_main = function(flg) {
        ...
        if ($scope.array_receipt_gl_form.acc_code == undefined || $scope.array_receipt_gl_form.acc_code == null) {
            ...
            // console.log($scope.array_receipt_gl_form);
            ...
            //rec.repeat_types = $scope.array_submit_jurnal.repeat_type !== undefined ? $scope.array_submit_jurnal.repeat_type.value : 0;

            // rec2.template_ids = $scope.array_submit_jurnal.template_id !== undefined ? $scope.array_submit_jurnal.template_id.id : 0;
    ...
    $scope.setdoctype = function(item, flg) {
        ...
        /* if (item.module_type.value == 2) {
            ...
            if (item.doc_type.id == 1) { // || item.doc_type.id == 4
            ...
            if (item.doc_type.id == 2 || item.doc_type.id == 3) {
            ...
            if (item.doc_type.id == 1 || item.doc_type.id == 4) { // || item.doc_type.id == 4
    ...
    if ($state.current.name != 'app.openingBalances' && $state.current.name != 'app.view-openingBalances') {
        ...
        if ($scope.data.id == 0) {
            ...
            // $scope.sale_type_array = [{ value: '2', name: 'Customer' }];
            ...
            // $scope.sale_type_array = [{ value: '3', name: 'Supplier' }];
            ...
            if (res.data.ack == true) {
                ...
                if (Number($scope.temp_id) > 0) {
                    ...
                    angular.forEach($scope.receipt_sub_list, function(obj_rec) {
                        ...
                        /*$.each($rootScope.arr_currency, function (index, elem) {
                         if (elem.id == $scope.$root.defaultCurrency)  obj_rec.currency_id_new = elem;
                         }); obj_rec.currency_id_new.id*/
                        // if (obj_rec.currency_id !== $scope.currency_id_defult.id) {
                        ...
                        // } else
                        // obj_rec.currency_id = $scope.currency_id_defult;
                ...
                if (Number($scope.temp_id) == 0) {
                    ...
                    /* $scope.receipt_sub_list = [{
                        ...
                        currency_id: $scope.array_submit_jurnal.currency_id,

                        module_type: $scope.fix_selected_rec
            ...
            if (res.data.ack == true) {
                ...
                if (Number($scope.temp_id) > 0) {
                    ...
                    angular.forEach($scope.receipt_sub_list, function(obj_rec) {
                        ...
                        // obj_rec.arr_warehouse = obj_rec.arr_warehouse.response;
                        ...
                        // obj_rec.allocated_stock = 0;

                        obj_rec.remainig_qty = Number(obj_rec.qty) - Number(obj_rec.allocated_stock);

                        /* if (obj_rec.item_stock_allocation.response != undefined) {

                            obj_rec.item_stock_allocation = obj_rec.item_stock_allocation.response;



                            obj_rec.journal_status = obj_rec.item_stock_allocation[0].journal_status;

                            var ordqty = 0;

                            angular.forEach(obj_rec.item_stock_allocation, function (elem) {
                            ...
                            obj_rec.remainig_qty = Number(obj_rec.qty) - Number(ordqty);

                            obj_rec.allocated_stock = ordqty;

                        }

                        else {

                            obj_rec.remainig_qty = obj_rec.qty;

                            obj_rec.journal_status = 0;
    ...
    $scope.edit_gl_recipt_sublist = function(id) {
        ...
        /*       $scope.array_submit_jurnal = {};
         ...
         if (elem.id == $scope.$root.defaultCurrency) $scope.array_submit_jurnal.currency_id = elem;
    ...
    $scope.AddReceiptRow = function(item) {
        ...
        // if (item.module_type !== undefined || item.module_type !== null) {
    ...
    $scope.netBalanceRecipt = function() {
        ...
        angular.forEach($scope.receipt_sub_list, function(item) {
            ...
            /* if ((item.module_type !== undefined) && (item.balancing_account_code !== undefined) && item.balancing_account_code !== null) {

                //		console.log(item.balancing_account_code);

                if (item.module_type.value == 1)

                    dtotal += Number(item.converted_price);
            ...
            if (item.balancing_account_code == undefined || item.balancing_account_code == "") {
                ...
                if (Number(item.credit_amount) > 0) {
                    ...
                    // $scope.t_credit_total += parseFloat(item.credit_amount);
                ...
                if (Number(item.debit_amount) > 0) {
                    ...
                    // $scope.t_debit_total += parseFloat(item.debit_amount);
        ...
        if (data.module_type.value == 1) {
            ...
            angular.forEach($scope.receipt_sub_list, function(obj, index) {
                ...
                if (obj.module_type !== undefined) {
                    ...
                    //obj.module_type.value==1  &&

                    //	if(indx != index) 	{

                    //	if(data.journal_date==obj.journal_date)



                    //	if( ( Number(data.credit_amount) + Number(data.debit_amount) )!=( Number(obj.debit_amount) + Number(obj.credit_amount) ))
    ...
    $scope.getItemList = function(item_paging, item, index) {
        ...
        angular.forEach($scope.tempProdArr, function (obj_rec, index) {

            obj_rec.name = obj_rec.description;

            obj_rec.code = obj_rec.product_code;

            // $scope.account_list.push({ id: obj_rec.id, name: obj_rec.description, code: obj_rec.product_code });

            $scope.account_list.push(obj_rec);
            ...
            if (index === $scope.account_index) {
...

                {
                    ...
                    /* angular.forEach(obj_rec.arr_units, function(elem){
                        ...
                        if(elem.unit_id == number.unit_id)
        ...
        angular.forEach($scope.receipt_sub_list, function(obj_rec, index) {
            ...
            if (index === $scope.account_index) {
                ...
                if ($scope.gltype == 0) {
                    ...
                    /* var postUrl =$scope.$root.stock + "products-listing/get-warehouse-uom-by-id";

                    

                    $http

                        .post(postUrl, { 'item_id': number.id, token: $scope.$root.token })
                        ...
                        .then(function (res) {
                            ...
                            if (res.data.ack == true) {
                                ...
                                obj_rec.arr_units = res.data.response[0].arr_units.response;

                                angular.forEach(obj_rec.arr_units, function(elem){

                                    if(elem.unit_id == res.data.response[0].unit_id)

                                        obj_rec.uom = elem;

                                });

                                if(res.data.response[0].arr_warehouse != undefined){

                                    obj_rec.arr_warehouse = res.data.response[0].arr_warehouse.response;
                        ...
                        .then(function(res) {
                            ...
                            if (res.data.ack == true) {
                                ...
                                if (res.data.response.posting_group_id === undefined || res.data.response.posting_group_id === null || res.data.response.posting_group_id == 0) {
                                    ...
                                    /* $.each($scope.currency_arr_local, function (index, elem3) {

                                        if (elem3.id == res.data.response.currency_id)
                        ...
                        .then(function(res) {
                            ...
                            if (res.data.ack == true) {
                                ...
                                if (res.data.response.posting_group_id === undefined || res.data.response.posting_group_id === null || res.data.response.posting_group_id == 0) {
                                    ...
                                    //obj_rec.currency_id = res.data.response.currency_id;
                    ...
                    // obj_rec.balancing_account_code = number.code + " - " + number.name;
            ...
            .then(function(res) {
                ...
                if (res.data.ack == true) {
                    ...
                    if (item.module_type === undefined) {
                        ...
                        // $scope.amount_total = item.orignal_amount;
    ...
    $scope.getAllocatStockPostive = function(warehouse_id, item_id, order_id, getAllocatStockCount) {
        ...
        var getStockUrl = $scope.$root.setup + "warehouse/get-purchase-stock";
        ...
        return $http
            ...
            .then(function (res) {
                ...
                // console.log($scope.formData.total_available_qty);

            }).catch(function (e) {

                if (getAllocatStockCount != 0) return $scope.getAllocatStockPostive(warehouse_id, item_id, order_id, getAllocatStockCount - 1);
...
function GlControllerOpeningBalance($scope, $stateParams, $http, $state, $resource, toaster, $window, ngDialog, dataService, $rootScope, $timeout, $filter) {
    ...
    $scope.postOpeningBalance = function() {
        ...
        if ($scope.sub_module_type == 2) {
            ...
            angular.forEach($scope.items, function(item, idx) {
                ...
                // console.log("loop idx: ", _idx, " = ", $scope.items.length - 1)

                if (keepValidating == 0) {

                    // console.log(!item.warehouses.hasOwnProperty('name'));
        ...
        ngDialog.openConfirm({
            ...
            // post.module_type = $scope.sub_module_type;
    ...
    $scope.getCurrencyList = function() {
        ...
        // if ($rootScope.newCurrencyList.length > 0) return;
